...
class PhysicsThing extends FlxNapeSprite {
    ...
    private static var sensors = [
        ...
        AssetPaths.Martini__png => [
            S.get(0, -55, "martini_small", 7),
            S.get(0, -55, "martini_large", 10),
        ],
	...
	private var materialTypes = [
        ...
        AssetPaths.Bone__png => FOOD_MATERIAL_NAME,
        AssetPaths.Chicken__png => FOOD_MATERIAL_NAME,
        AssetPaths.Bread__png => FOOD_MATERIAL_NAME,
