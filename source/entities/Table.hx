...
class Table extends PhysicsThing {
	...
	private var tableConfigurations = [
		...
		new TableConfiguration([
			...
			new ThingDef(-49, -141, AssetPaths.Bone__png, null, true),
			new ThingDef(51, -141, AssetPaths.Chicken__png, null, true),
			new ThingDef(51, -141, AssetPaths.Steak__png, null, true),
		]),
		// new TableConfiguration([
